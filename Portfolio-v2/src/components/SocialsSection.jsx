...
export default function SocialsSection() {
  return (
    <section id="socials" className="portfolio-section">
      <SectionHeading number="07" title="Socials" id="socials-heading" />
      <div className="socials-row">
        {socialsData.map((social) => (
          ...
          >
            <span className="social-link__icon">{icons[social.platform]}</span>
            <span className="social-link__name">{social.platform}</span>
          </a>
        ))}
      </div>
    </section>
